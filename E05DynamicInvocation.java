...
public class E05DynamicInvocation {
    ...
    public static void main(String[] args) {
        ...
        try {
            // get the "get" method
            Method g = v.getClass().getMethod("get", new Class[]{int.class});
            ...
            Method a = v.getClass().getMethod("add", new Class[]{Object.class});
            ...
            // Anche se due classi hanno un metodo con lo stessa signature, non posso reperirne uno ed usarlo
